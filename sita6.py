...
targets = []
Bots=[mid]
admin = ["u3954153058195643e684ea29ab880f4c"]
owner = ["u3954153058195643e684ea29ab880f4c"]
wait = {
    "alwayRead":False,
    "detectMention":True,
    'potoMention':False,
        ...
        if op.type == 25:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["anu Lagi Off Kalau Penting Pc Aja",cName + " tag mulu jones?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Sita Nya lagi off kak", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","Tersummon (-_-)"]
...
#==================================================================
            ...
            elif "Admin ad @" in msg.text:
                if msg.from_ in admin:
                    print "[Command]Staff add executing"
                    _name = msg.text.replace("Admin ad @","")
            ...
            elif "admin ex @" in msg.text:
                if msg.from_ in admin:
                    print "[Command]Staff remove executing"
                    _name = msg.text.replace("admin ex @","")
                    _nametarget = _name.rstrip(' ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
...
#=====================================================================================@
            ...
            elif msg.text in ["Autorespon","Respon:on"]:
                wait["detectMention"] = True
                cl.sendText(msg.to,"Auto Respon ON")

            elif msg.text in ["Autorespon","Respon:off"]:
            ...
            elif msg.text in ["Tag on","Responkick:on"]:
                wait["kickMention"] = True
                cl.sendText(msg.to,"[AUTO RESPOND] Auto Kick yang tag ON")

            elif msg.text in ["Tag off","Responkick:off"]:
...
#====================================================================================#
                    ...
                    wait["Sider"] == True
                    cl.sendText(msg.to,"Šîđēr §üđáh on..!!!")

            elif msg.text in ["Sider off","sider off"]:
                    if msg.to in cctv['point']:
                        cctv['cyduk'][msg.to]=False
                        wait["Sider"] = False
                        cl.sendText(msg.to,"§ïđ€r §ûđåh Ø₣₣")
                    else:
                        cl.sendText(msg.to,"Belum Di Set Boss")
#==========================================================================================#
