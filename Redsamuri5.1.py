...
╚═════════════════════════
"""
tjia="u94a1bc387b927e86756334648d314f86"
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Majikan Kami (^_^)")
                ...
                msg.contentType = 13
                admin1 = "u94a1bc387b927e86756334648d314f86"
                admin2 = "ub5abe828cd964292195c3c59d6322033"
                admin3 = "u656b0ca994a1c9b462f9feb6f5ae3177"
                msg.contentMetadata = {'mid': tjia}
		...
		cl.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            elif msg.text in ["Key creator","helpc","Help creator"]:
                cl.sendText(msg.to,creatorMessage)

            elif msg.text in ["Key group","helpg","Help group"]:
                cl.sendText(msg.to,groupMessage)

            elif msg.text in ["Key","help","Help"]:
                cl.sendText(msg.to,helpMessage)

            elif msg.text in ["Key self","helps1","Help self"]:
                cl.sendText(msg.to,selfMessage)

            elif msg.text in ["Key bot","helpb","Help bot"]:
                cl.sendText(msg.to,botMessage)

            elif msg.text in ["Key set","helps","Help set"]:
                cl.sendText(msg.to,setMessage)

            elif msg.text in ["Key media","helpm","Help media"]:
                cl.sendText(msg.to,mediaMessage)
                
            elif msg.text in ["Key admin","helpa","Help admin"]:
                cl.sendText(msg.to,adminMessage)    
                
            elif msg.text in ["Key protect","helpp","Help protect"]:
