...
ki1 = LINETCR.LINE()
ki1.login(token="EqVLbPafRZ9mAaI1Z6L3.FXP8F/ZJ0UQHfIxYmKf0iW.mYvpkhLLWpKdAO36w2GKiSSHncqdKhB112PKaIPL0b0=")
ki1.loginResult()
...
ki6 = LINETCR.LINE()
ki6.login(token="EqIj7X6z9phSDiaMWOvd.ggx7QWxQIfYNVuGEW1YAhq.pvbnFeabbE4LMt6qdKVkEOa12J+r/3GYcD87BKwGNnY=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="EqzFBUjI8B1viqla4da9.gU3VI4Ik4qJzA6Y8uftMEq.DSyFLWGVwKsRelfnRmCv2bcCtm6mIy7jVBpWtuq7Glc=")
ki7.loginResult()

ki8 = LINETCR.LINE()
ki8.login(token="EqQYiuojsIVJ0uXI8oU7.zwSmQzsHYBrI/F629A4XDW.B70LRj2iJvz8ehHul01XWD0W3CkCo5DlRn0WjRIEJYA=")
ki8.loginResult()

ki9 = LINETCR.LINE()
ki9.login(token="EqAZXYflbv6S396HaqH6.MC3I4QsKSrV9tmqyKt6jHG.LyUlAJnjRR3cCFZTg9m7uzvuZJ5zsPnTu3ws29Qc8b8=")
ki9.loginResult()

ki10 = LINETCR.LINE()
ki10.login(token="EqlCJd8ELUvEBwD97My8.wZxjCuYJwwfJnE+TIiu3Qa.ptsqYuZXwrSfCFDa6dNoVRqbfxSl6EEBrMkgVgKvohA=")
ki10.loginResult()
...
❂͜͡☆➣ 〘checkdate 〙
❂͜͡☆➣ 『{}』คอนแทคไวรัส
❂͜͡☆➣ 『tag1』เช็คข้อความแทค1
❂͜͡☆➣ 『tag2』เช็คข้อความแทค2
...
❂͜͡☆➣ 『PK2@』คิกเตะ
❂͜͡☆➣ 『ลบรัน』
❂͜͡☆➣ 『กลุ่ม』เช็คข้อมูลกลุ่ม

กรุณาพิมพ์  Sett เพื่อ
ดูการตั้งค่าข้อความ

กรุณาพิมพ์ Set เพื่อ
ดูการตั้งค่าบอท

กรุณาพิมพ์ Cmd เพื่อ
ดูฟังชั่นบอท2
...
║         ✦โหมดตั้งค่าข้อความ✦
╠══════════════════════
║✰ Red1˓: ➠ไส่ข้อความต้อนรับ
║✰ Red2˓: ➠ไส่ข้อความออกจากกลุ่ม
║✰ Red3˓: ➠ไส่ข้อความเมื่อมีคนลบ
╚══════════════════════
╔══════════════════════
║       ✦โหมดเช็คตั้งค่าข้อความ✦
╠══════════════════════
║✰ Red1 ➠เช็คข้อความต้อนรับ
║✰ Red2 ➠เช็คข้อความคนออก
║✰ Red3 ➠เช็คข้อความคนลบ
╚══════════════════════"""
...
admsa = "u94a1bc387b927e86756334648d314f86","u5b35c9714ca359616335efed888537a8","ube52b8931eee2e15a1b689377e3e5637","u1aedef8b888ae108d96bacbc5054e679","u99cde2e2a4a4b11bfd4cc418913e8986","u1865fbab05ea885ca7bd481ec35c9a1d","u46a050ebcc66a90b47fae6256547cc53","u656b0ca994a1c9b462f9feb6f5ae3177","ub5abe828cd964292195c3c59d6322033"
owner = "u94a1bc387b927e86756334648d314f86","u5b35c9714ca359616335efed888537a8","ube52b8931eee2e15a1b689377e3e5637","u1aedef8b888ae108d96bacbc5054e679","u99cde2e2a4a4b11bfd4cc418913e8986","u1865fbab05ea885ca7bd481ec35c9a1d","u46a050ebcc66a90b47fae6256547cc53","u656b0ca994a1c9b462f9feb6f5ae3177","ub5abe828cd964292195c3c59d6322033"
adminMID = "u94a1bc387b927e86756334648d314f86","u5b35c9714ca359616335efed888537a8","ube52b8931eee2e15a1b689377e3e5637","u1aedef8b888ae108d96bacbc5054e679","u99cde2e2a4a4b11bfd4cc418913e8986","u1865fbab05ea885ca7bd481ec35c9a1d","u46a050ebcc66a90b47fae6256547cc53","u656b0ca994a1c9b462f9feb6f5ae3177","ub5abe828cd964292195c3c59d6322033"
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Thanks for add Me MY NAME IS Red",
    "lang":"JP",
    "comment":"AutoLike by Red",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'ub5abe828cd964292195c3c59d6322033'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/~samuri5")
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
            elif msg.text in ["เข้ามา","#Kicker","#kicker","Kicker","kicker","•••"]:
                        ...
                        ki1.sendText(msg.to,"[SELFBOT BY. RED BOT]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[HAHA]")
...
#==================================================
				...
				msg.contentMetadata = {'mid': mid}
				cl.sendMessage(msg)
				cl.sendText(msg.to,"[SELFBOT BY RED BOT]")
            elif "Id" == msg.text:
                key = msg.to
...
#-----------------------------------------------
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"ปฏิเสธคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
...
#========================================
#========================================
            elif "Add set:" in msg.text:
                wait["message"] = msg.text.replace("Add set:","")
...
#===============================================
                ...
                ki.sendText(msg.to, "[SELFBOT MIN HACK BOT]\n\n❂͜͡☆➣ Namelock on\n❂͜͡☆➣ Namelock off\n❂͜͡☆➣ Blockinvite on\n❂͜͡☆➣ Blockinvite off\n❂͜͡☆➣ Backup on\n❂͜͡☆➣ Backup off\n\n[By.Red]")
...
#======================================================#
                ...
                cl.sendImageWithUrl(msg.to, "http://dl.profile.line.naver.jp/0hIz2A56kmFlUPODpM4NBpAjN9GDh4FgcdYV5bYHlqG2J3CFhUM1lZMCtoGG0iWFADYA4LNCs_H2dx")
#======================================================#
...
#-------------------------------------------------
                ...
                msg.contentMetadata = {'mid': 'u5b35c9714ca359616335efed888537a8'}
                cl.sendMessage(msg)
                ...
                msg.contentMetadata = {'mid': 'ube52b8931eee2e15a1b689377e3e5637'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "รองประธาน:")
                msg.contentMetadata = {'mid': 'u1aedef8b888ae108d96bacbc5054e679'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "รปภ.:")
                msg.contentMetadata = {'mid': 'u1865fbab05ea885ca7bd481ec35c9a1d'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ตัวเเทนสมาชิก")
                msg.contentMetadata = {'mid': 'u46a050ebcc66a90b47fae6256547cc53'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ตัวเเทนสมาชิก")
                msg.contentMetadata = {'mid': 'u656b0ca994a1c9b462f9feb6f5ae3177'}
                cl.sendMessage(msg)
...
#==============================================================================#
            ...
            elif "Redmic " in msg.text:
                cmd = msg.text.replace("Redmic ","")
                if cmd == "on":
                    if mimic["status"] == False:
                        mimic["status"] = True
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    raise e
            elif "Redtagall" in msg.text:
                       nk0 = msg.text.replace("Redtagall","")
                       nk1 = nk0.lstrip()
                       nk2 = nk1.replace("","")
                       nk3 = nk2.rstrip()
                       _name = nk3
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 25:
            ...
            if msg.text.lower() in ["pheytcg fgtagg all"]:
                ...
                cnt = Message()
                cnt.text = "RED TAG DONE : " + str(jml) +  " Members"
                cnt.to = msg.to
                cl.sendMessage(cnt)
        ...
        if op.type == 25:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"แว้.....")
            elif msg.text in ["เรส","ป๊า","ป๊าเรส"]:
                        cl.sendText(msg.to,"ครับมีไรหาเมียน้อยอยู่...")
            elif msg.text in ["อยู่ไหม",".อยู่ใหม","อยู่มั้ย"]:
