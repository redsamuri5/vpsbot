...
ki = LINETCR.LINE()
ki.login(token="EqkclWTahoRvY30HN7P3.rQbq68XMQqTh/UyLzuFmuW.22O7uj36c3oz1Q9vBLVIDZLX1MXJWDGp7JUC3A1lqa0=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EqVLbPafRZ9mAaI1Z6L3.FXP8F/ZJ0UQHfIxYmKf0iW.mYvpkhLLWpKdAO36w2GKiSSHncqdKhB112PKaIPL0b0=")
ki2.loginResult()
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""ขอบคุณที่เพิ่มผมเป็นเพื่อนนะคับ"😊
    SelfBot 
☆ By.Redbot☆""",

    "lang":"JP",
    "comment":"🙏ขอบคุณที่แอดมานาจ๊ะ😁ว่าแต่แอดมาทมายเอ่ย?..แอดมาแล้วไม่ทักบล็อคนะ👌",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
